...
PhongTest::PhongTest(HINSTANCE hInstance)
	: MainApp(hInstance)
...
bool PhongTest::Initialize(UINT Width, UINT Height)
{
...
bool PhongTest::InitScene()
{
    ...
    ID3DBlob* vertexShaderBuffer = nullptr;
    {
        ...
        HR_T(CompileShaderFromFile(L"PhongTest_VS.hlsl", "main", "vs_4_0", &vertexShaderBuffer));
    ...
    /// 5. Render() 에서 파이프라인에 바인딩할 픽셀 셰이더 생성
    {
        ...
        HR_T(CompileShaderFromFile(L"PhongTest_PS.hlsl", "main", "ps_4_0", &pixelShaderBuffer));
...
LRESULT CALLBACK PhongTest::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
