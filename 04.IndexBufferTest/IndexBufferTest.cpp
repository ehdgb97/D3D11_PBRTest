...
IndexBufferTest::IndexBufferTest(HINSTANCE hInstance)
    :MainApp(hInstance)
{
}
...
bool IndexBufferTest::Initialize(UINT Width, UINT Height)
{
...
void IndexBufferTest::UninitD3D()
{
...
bool IndexBufferTest::InitScene()
{
    using namespace DirectX::SimpleMath;
    HRESULT hr = 0; // 결과값.
...
void IndexBufferTest::UninitScene()
{
