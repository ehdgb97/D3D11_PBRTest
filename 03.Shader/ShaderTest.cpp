...
ShaderTest::ShaderTest(HINSTANCE hInstance)
    :MainApp(hInstance)
{
}
...
bool ShaderTest::Initialize(UINT Width, UINT Height)
{
...
bool ShaderTest::InitScene()
{
	...
	Vertex vertices[] =
	{
	    Vertex(Vector3(-0.5,0.5,0.3),Vector4(1.0f, 0.0f, 0.0f, 1.0f)), // v0   
	    Vertex(Vector3(0.5,0.5,0.3),Vector4(1.0f, 0.0f, 0.0f, 1.0f)),	// v1   
	    Vertex(Vector3(-0.5,-0.5,0.3) ,Vector4(1.0f, 0.0f, 0.0f, 1.0f)),	// v2

		Vertex(Vector3(-0.5,-0.5,0.5),Vector4(0.0f, 0.0f, 1.0f, 1.0f)),	// v2
		Vertex(Vector3(0.5,0.5,0.5),Vector4(0.0f, 1.0f, 0.0f, 1.0f)),	// v1    
		Vertex(Vector3(0.5,-0.5,0.5),Vector4(1.0f, 0.0f, 0.0f, 1.0f)),		// v1    
	};
